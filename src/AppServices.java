/**
 * Root object for campus services. Obtained only via {@link AppServicesFactory#getServices()} or
 * {@link #get()} — Creational <strong>Singleton</strong> (one instance per application).
 */
